...
return [
    ...
    'quick_filters' => [
        ...
        'more_indicator_labels' => 'und :count mehr',
    ...
    'multi_sort' => [
        ...
        'add_column_label' => 'Spalte hinzufügen',
    ...
    'view_manager' => [
        ...
        'actions' => [
            ...
            'set_as_managed_default_view' => 'Als Standard festlegen',
            'remove_as_managed_default_view' => 'Als Standard entfernen',
